...
| Informação | Valor |
|------------|-------|
| **Período** | 19/01/2026 (Dom) → 02/02/2026 (Dom) |
| **Duração** | 15 dias / 14 noites |
| **Distância Total** | ~3.200 km |
| **Média Diária** | 213 km |
...
## Fase 1: Deslocamento Goiânia → Serras (Dias 1-4)
...
- 06:00 - Saída de Ponta Grossa
- 08:00 - Parada em Lapa (café rápido)
- 10:00 - Passagem por Lages (combustível)
- 13:00 - Chegada em Urubici

!!! warning "Atenção"
    - Dia mais longo, saída cedo obrigatória
    - Entrando na região serrana - temperatura cai
    - Urubici: noites frias mesmo no verão (5-10°C)
    - Prepare segunda pele térmica
...
**Urubici - SC (Dia de Exploração)**

| Item | Detalhe |
|------|---------|
| **Distância** | ~60 km (passeios) |
| **Atividades** | Serra do Corvo Branco + Pedra Furada |

#### Serra do Corvo Branco

!!! danger "ATENÇÃO"
    O trecho Corvo Branco → Grão-Pará está **FECHADO até março/2026**.
    Acesso liberado: Urubici → Corte em Rocha (mirantes) - ida e volta.

| Informação | Detalhe |
|------------|---------|
| **Altitude máxima** | 1.140m |
| **Extensão acessível** | ~8 km (ida e volta) |
| **Ingresso** | R$ 80/pessoa (Parque Altos do Corvo Branco) |

**Roteiro sugerido:**

- 08:00 - Saída para Serra do Corvo Branco
...
- 13:00 - Almoço
- 15:00 - Trilha da Pedra Furada (1,5 km - fácil)
- 17:00 - Pôr do sol na Pedra Furada (melhor luz!)
- 19:00 - Jantar em Urubici

**Outras opções em Urubici:**
...
!!! note "Nota"
    Esta rota contorna o trecho fechado do Corvo Branco.
...
**Bom Jardim da Serra - SC → Cambará do Sul - RS**
...
- 08:00 - Saída de Bom Jardim
- 10:00 - Passagem por São Joaquim (parada rápida - café)
- 11:30 - Divisa SC/RS
- 13:00 - Chegada em Cambará do Sul

**São Joaquim (parada rápida):**

- Cidade mais fria do Brasil (altitude 1.360m)
- Famosa pelas maçãs e vinhos de altitude
- Se quiser estender: Vinícola Villa Francioni
...
| Cânion | Profundidade | Destaque |
|--------|--------------|----------|
| **Itaimbezinho** | 720m | Maior do Brasil |
| **Fortaleza** | 900m | Vistas mais dramáticas |
...
- 08:00-12:00 - Trilhas Itaimbezinho
    ...
    - Trilha do Cotovelo (6 km) - Moderada (IMPERDÍVEL!)
- 12:30 - Almoço
...
!!! tip "Dicas"
    - Chegar cedo (neblina comum de manhã)
...
**Cambará do Sul - RS → Bento Gonçalves - RS**
...
- 13:00 - Chegada em Bento Gonçalves
...
**Bento Gonçalves - RS (Dia nas Vinícolas)**

| Item | Detalhe |
|------|---------|
| **Distância** | ~40 km (circulando pelas vinícolas) |
| **Atividades** | Tour de vinícolas |
...
- 06:00 - Saída de Bento Gonçalves
- 08:30 - Passagem por Vacaria (café + combustível)
- 10:30 - Divisa RS/SC
- 12:00 - Divisa SC/PR
- 13:30 - Chegada em Curitiba

!!! tip "Dicas"
    - Dia longo, saída bem cedo
    - BR-116 bem pavimentada
    - Atenção: transição de clima (pode esfriar na serra)
...
| Item | Detalhe |
|------|---------|
| **Atividades** | Descanso, turismo, revisão da moto |

**O que fazer em Curitiba:**

- Jardim Botânico (ícone da cidade)
- Ópera de Arame
- Centro Histórico (Largo da Ordem)
- Bairro italiano de Santa Felicidade (jantar!)

**Manutenção da moto:**

- [ ] Revisar pressão dos pneus
- [ ] Lubrificar corrente
...
- 07:00 - Saída de Ourinhos
- 09:30 - Parada em Marília (café)
- 11:00 - Parada em Ribeirão Preto (combustível)
...
| Cânions e Serra | 7-10 | ~460 | Cânions, Vinhedos |
...
Você tem **DUAS OPÇÕES** de rota de retorno a partir de Bento Gonçalves:

### Opção 1: Retorno Rápido (Asfaltado) - PADRÃO

```
Bento Gonçalves → Vacaria → Curitiba → Ourinhos → Uberaba → Goiânia
```

- **Total:** ~1.570 km em 5 dias
- **Média:** 314 km/dia
- **Vantagem:** Mais rápido, estradas melhores

### Opção 2: Retorno Cênico (Via São José dos Ausentes)

```
Bento → São José dos Ausentes → Vacaria → Lages → Curitiba → Goiânia
```

- **Total:** ~1.700 km em 5 dias
- **Média:** 340 km/dia
- **Vantagem:** Paisagens incríveis, revisita a serra

**Decida durante a viagem conforme seu estado de ânimo e cansaço!**
...
| Alerta | Detalhe |
|--------|---------|
| Serra do Corvo Branco | Travessia fechada até março/2026 - acesso apenas ida/volta por Urubici |
| Tirolesa Fortaleza | Fechada desde maio/2024 |
| Gramado em janeiro | Lotada (alta temporada) - NÃO incluída neste roteiro |
| Neblina nas serras | Comum de manhã - aguarde dissipar antes de pegar estrada |
